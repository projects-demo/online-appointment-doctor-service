...
public final class AdService {
  ...
  private void start() throws IOException {
	  String AD_SERVICE_PORT = "8080";
    int port =
        Integer.parseInt(
            Optional.ofNullable(AD_SERVICE_PORT)
                .orElseThrow(
                    () ->
    ...
    String FEATURE_FLAG_GRPC_SERVICE_ADDR = "featureflagservice:50053";
    String featureFlagServiceAddr = FEATURE_FLAG_GRPC_SERVICE_ADDR;
/**    String featureFlagServiceAddr =
        Optional.ofNullable(FEATURE_FLAG_GRPC_SERVICE_ADDR)
            .orElseThrow(
                () ->
                    new IllegalStateException(
